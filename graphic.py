...
axs[0].plot(df['linear_vel_error'], color='black', linewidth=1.5, linestyle=':', label='Linear Velocity Error')
axs[0].plot(df['actual_linear_vel'], color='red', linestyle='--', linewidth=2, label='Actual Linear Velocity')
axs[0].set_ylabel('Linear Velocity Error')
axs[0].set_title('MPC vs. Actual Linear Velocity Error')
axs[0].grid(True)
axs[0].legend()
