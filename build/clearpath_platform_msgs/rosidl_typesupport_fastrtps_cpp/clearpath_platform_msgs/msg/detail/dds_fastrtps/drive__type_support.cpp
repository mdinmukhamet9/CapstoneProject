...
#include "clearpath_platform_msgs/msg/detail/drive__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const clearpath_platform_msgs::msg::Drive & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_platform_msgs::msg::Drive & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs::msg::Drive;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::msg::Drive *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_platform_msgs::msg::Drive *>(
    untyped_ros_message);
...
{
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_Drive__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, msg, Drive)() {
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_Drive__handle;
}
