...
#include "clearpath_platform_msgs/msg/detail/stop_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const clearpath_platform_msgs::msg::StopStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  clearpath_platform_msgs::msg::StopStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs::msg::StopStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::msg::StopStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_platform_msgs::msg::StopStatus *>(
    untyped_ros_message);
...
static size_t _StopStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StopStatus(full_bounded, is_plain, 0);
...
{
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_StopStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, msg, StopStatus)() {
  return &clearpath_platform_msgs::msg::typesupport_fastrtps_cpp::_StopStatus__handle;
}
