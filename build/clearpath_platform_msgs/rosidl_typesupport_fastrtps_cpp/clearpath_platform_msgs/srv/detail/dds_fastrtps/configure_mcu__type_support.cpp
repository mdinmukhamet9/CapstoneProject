...
#include "clearpath_platform_msgs/srv/detail/configure_mcu__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs::srv::ConfigureMcu_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::srv::ConfigureMcu_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<clearpath_platform_msgs::srv::ConfigureMcu_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConfigureMcu_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::srv::ConfigureMcu_Request *>(
...
static size_t _ConfigureMcu_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ConfigureMcu_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ConfigureMcu_Request__callbacks = {
...
static rosidl_message_type_support_t _ConfigureMcu_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConfigureMcu_Request__callbacks,
...
{
  return &clearpath_platform_msgs::srv::typesupport_fastrtps_cpp::_ConfigureMcu_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = clearpath_platform_msgs::srv::ConfigureMcu_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::srv::ConfigureMcu_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<clearpath_platform_msgs::srv::ConfigureMcu_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConfigureMcu_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const clearpath_platform_msgs::srv::ConfigureMcu_Response *>(
...
static size_t _ConfigureMcu_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ConfigureMcu_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ConfigureMcu_Response__callbacks = {
  "clearpath_platform_msgs::srv",
...
static rosidl_message_type_support_t _ConfigureMcu_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConfigureMcu_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &clearpath_platform_msgs::srv::typesupport_fastrtps_cpp::_ConfigureMcu_Response__handle;
}
...
static service_type_support_callbacks_t _ConfigureMcu__callbacks = {
  "clearpath_platform_msgs::srv",
  "ConfigureMcu",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, srv, ConfigureMcu_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, srv, ConfigureMcu_Response)(),
...
static rosidl_service_type_support_t _ConfigureMcu__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConfigureMcu__callbacks,
...
{
  return &clearpath_platform_msgs::srv::typesupport_fastrtps_cpp::_ConfigureMcu__handle;
}
