...
#include "clearpath_platform_msgs/msg/detail/feedback__rosidl_typesupport_fastrtps_c.h"
...
#include "clearpath_platform_msgs/msg/detail/drive_feedback__functions.h"  // drivers
...
using _Feedback__ros_msg_type = clearpath_platform_msgs__msg__Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: drivers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, clearpath_platform_msgs, msg, DriveFeedback
      )()->data);
    size_t size = 2;
...
size_t get_serialized_size_clearpath_platform_msgs__msg__Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Feedback__ros_msg_type * ros_message = static_cast<const _Feedback__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_clearpath_platform_msgs__msg__DriveFeedback(
...
static uint32_t _Feedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_clearpath_platform_msgs__msg__Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
size_t max_serialized_size_clearpath_platform_msgs__msg__Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: drivers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_clearpath_platform_msgs__msg__DriveFeedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs__msg__Feedback;
    is_plain =
      (
...
static size_t _Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_clearpath_platform_msgs__msg__Feedback(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, clearpath_platform_msgs, msg, Feedback)() {
