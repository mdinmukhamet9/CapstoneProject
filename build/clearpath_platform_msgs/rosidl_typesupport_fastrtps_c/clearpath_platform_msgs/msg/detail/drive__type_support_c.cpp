...
#include "clearpath_platform_msgs/msg/detail/drive__rosidl_typesupport_fastrtps_c.h"
...
using _Drive__ros_msg_type = clearpath_platform_msgs__msg__Drive;
...
size_t get_serialized_size_clearpath_platform_msgs__msg__Drive(
  const void * untyped_ros_message,
...
static uint32_t _Drive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_clearpath_platform_msgs__msg__Drive(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_clearpath_platform_msgs
size_t max_serialized_size_clearpath_platform_msgs__msg__Drive(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs__msg__Drive;
    is_plain =
      (
...
static size_t _Drive__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_clearpath_platform_msgs__msg__Drive(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, clearpath_platform_msgs, msg, Drive)() {
