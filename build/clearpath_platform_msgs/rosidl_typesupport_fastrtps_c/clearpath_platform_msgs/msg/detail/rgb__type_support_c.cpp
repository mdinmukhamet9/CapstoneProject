...
#include "clearpath_platform_msgs/msg/detail/rgb__rosidl_typesupport_fastrtps_c.h"
...
using _RGB__ros_msg_type = clearpath_platform_msgs__msg__RGB;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RGB__ros_msg_type * ros_message = static_cast<const _RGB__ros_msg_type *>(untyped_ros_message);
  // Field name: red
  {
    cdr << ros_message->red;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _RGB__ros_msg_type * ros_message = static_cast<_RGB__ros_msg_type *>(untyped_ros_message);
  // Field name: red
  {
    cdr >> ros_message->red;
  }
...
static uint32_t _RGB__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_clearpath_platform_msgs__msg__RGB(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = clearpath_platform_msgs__msg__RGB;
    is_plain =
      (
...
static size_t _RGB__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_clearpath_platform_msgs__msg__RGB(
...
static message_type_support_callbacks_t __callbacks_RGB = {
...
static rosidl_message_type_support_t _RGB__type_support = {
