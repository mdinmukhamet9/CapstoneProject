...
static const _DriveFeedback_type_support_symbol_names_t _DriveFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clearpath_platform_msgs, msg, DriveFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, clearpath_platform_msgs, msg, DriveFeedback)),
  }
};
...
{
  return &::clearpath_platform_msgs::msg::rosidl_typesupport_cpp::DriveFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, clearpath_platform_msgs, msg, DriveFeedback)() {
  return get_message_type_support_handle<clearpath_platform_msgs::msg::DriveFeedback>();
}
