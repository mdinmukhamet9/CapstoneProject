...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        input_image_topic_cmd = DeclareLaunchArgument(
            "input_image_topic",
            default_value="/j100_0001/sensors/camera_0/color/image",
        ...
        input_depth_topic_cmd = DeclareLaunchArgument(
            "input_depth_topic",
            default_value="/j100_0001/sensors/camera_0/depth/image",
        ...
        input_depth_info_topic_cmd = DeclareLaunchArgument(
            ...
            default_value="/j100_0001/sensors/camera_0/depth/camera_info",
