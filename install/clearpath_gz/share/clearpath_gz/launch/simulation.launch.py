...
def generate_launch_description():
    ...
    joint_state_broadcaster = Node(
        ...
        executable='spawner',
        arguments=['joint_state_broadcaster', '--controller-manager', '/j100_0001/controller_manager', '--controller-manager-timeout', '20'],
        output='screen'
    )
    ...
    platform_velocity_controller = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['platform_velocity_controller', '--controller-manager', '/j100_0001/controller_manager', '--controller-manager-timeout', '20'],
        output='screen'
    )
