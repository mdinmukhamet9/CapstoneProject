...
{
  new (message_memory) clearpath_platform_msgs::msg::Drive(_init);
}

void Drive_fini_function(void * message_memory)
{
  auto typed_message = static_cast<clearpath_platform_msgs::msg::Drive *>(message_memory);
  typed_message->~Drive();
}
...
void fetch_function__Drive__drivers(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Drive__drivers(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Drive__drivers(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Drive__drivers(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Drive_message_member_array[2] = {
  {
    ...
    offsetof(clearpath_platform_msgs::msg::Drive, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(clearpath_platform_msgs::msg::Drive, drivers),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__Drive__drivers,  // fetch(index, &value) function pointer
    assign_function__Drive__drivers,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Drive_message_members = {
  ...
  "Drive",  // message name
  2,  // number of fields
  sizeof(clearpath_platform_msgs::msg::Drive),
...
{
  return &::clearpath_platform_msgs::msg::rosidl_typesupport_introspection_cpp::Drive_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, clearpath_platform_msgs, msg, Drive)() {
  return &::clearpath_platform_msgs::msg::rosidl_typesupport_introspection_cpp::Drive_message_type_support_handle;
}
