...
#ifndef CLEARPATH_PLATFORM_MSGS__MSG__DETAIL__DRIVE__FUNCTIONS_H_
#define CLEARPATH_PLATFORM_MSGS__MSG__DETAIL__DRIVE__FUNCTIONS_H_
 ...
 * calls
 * clearpath_platform_msgs__msg__Drive__init().
...
/**
 * It calls
 * clearpath_platform_msgs__msg__Drive__fini()
 ...
 * clearpath_platform_msgs__msg__Drive__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * clearpath_platform_msgs__msg__Drive__Sequence__fini()
 * on the array,
...
#endif  // CLEARPATH_PLATFORM_MSGS__MSG__DETAIL__DRIVE__FUNCTIONS_H_
