...
#ifndef CLEARPATH_PLATFORM_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
#define CLEARPATH_PLATFORM_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
 ...
 * calls
 * clearpath_platform_msgs__msg__Status__init().
...
/**
 * It calls
 * clearpath_platform_msgs__msg__Status__fini()
 ...
 * clearpath_platform_msgs__msg__Status__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * clearpath_platform_msgs__msg__Status__Sequence__fini()
 * on the array,
...
#endif  // CLEARPATH_PLATFORM_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
